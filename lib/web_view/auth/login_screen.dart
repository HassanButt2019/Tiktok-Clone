...
class KWebLoginScreen extends StatelessWidget {
  KWebLoginScreen({Key? key}) : super(key: key);
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Make and Uload Your Videos  Socialise Yourself",
              ...
              children: [
                ...
                InkWell(
                  onTap: () => Navigator.of(context).pushReplacement(
                    MaterialPageRoute(
                      builder: (context) => KWebSignUpScreen(),
                    ),
                  ),
                  child: Text(
                    'Register',
