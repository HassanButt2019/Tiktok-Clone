          ...
          child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: InkWell(
                    onTap: ()=>uploadVideoController.uploadView(_songController.text,
                    ...
                    child: Center(
                      child: Row(
                        ...
                        children:  [
                          ...
                          Container(child: Obx((){
                            return uploadVideoController.isLoading.value?const CircularProgressIndicator(color: Colors.white,):Container();})
                          ),
                        ],
                      ),
                    ),
